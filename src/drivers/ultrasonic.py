...
class UltrasonicDriver:
    def __init__(self, cfg, devnode=None):
        port = devnode or cfg["interface"]["extra"].get("port", "/dev/ttyUSB0")
        ...
        try:
            ...
            log.error(f"Ultrasonic init failed: {e}")
            raise e
    ...
    def read_value(self):
        try:
            ...
            log.debug(f"Ultrasonic read failed: {e}")
            return None
